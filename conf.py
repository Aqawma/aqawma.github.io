...
BLOG_AUTHOR = "Max Goodfellow"  # (translatable)
BLOG_TITLE = "Learning Japanese to Live in Japan"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://japanese.maxgoodfellow.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://japanese.maxgoodfellow.com/"
BLOG_EMAIL = "me@maxgoodfellow.com"
BLOG_DESCRIPTION = "I am leaving the US in two months to go to an international school in Japan! This blog will document my progress in learning Japanese to well... live there!"  # (translatable)
